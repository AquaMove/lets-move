module 0x0::task5 {
    ...
    public entry fun deposit_my_coin(pool: &mut Pool, user_coin: Coin<ALVIN_COIN>, amount: u64, ctx: &mut TxContext) {
    ...
    public entry fun swap_my_coin_to_faucet_coin(pool: &mut Pool, user_coin: Coin<ALVIN_COIN>, amount: u64, ctx: &mut TxContext) {
