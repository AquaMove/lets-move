module 0x0::faucet_coin {
    ...
    fun init(witness: FAUCET_COIN, ctx: &mut TxContext) {
        let (treasury, metadata) = coin::create_currency(
            witness,
            2,
            b"nguyenminhtriet2k5", 
            b"NGUYENMINHTRIET2K5 FAUCET",
            b"DAY LA COIN FAUCET CUA NGUYENMINHTRIET2K5",
            some(url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/198740615?v=4")),
            ctx
        );
