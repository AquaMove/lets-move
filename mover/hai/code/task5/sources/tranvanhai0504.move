module 0x0::tranvanhai0504 {

    use sui::balance::{Self, Balance};
    use my_coin::my_coin::{MY_COIN};
    use my_another_coin::my_another_coin::{MY_ANOTHER_COIN};
    ...
    public struct Pool has key {
        ...
        faucet_coin: Balance<MY_ANOTHER_COIN>,
    }
    ...
    fun init(ctx: &mut TxContext) {
        let pool = Pool {
            ...
            faucet_coin: balance::zero<MY_ANOTHER_COIN>(),
        };
        transfer::share_object(pool);
    }

    entry fun add_money_to_pool(pool: &mut Pool, my_coin: Coin<MY_COIN>, faucet_coin: Coin<MY_ANOTHER_COIN>) {
    ...
    public entry fun deposit_faucet_coin(pool: &mut Pool, user_coin: Coin<MY_ANOTHER_COIN>, ctx: &mut TxContext) {
    ...
    public entry fun swap_faucet_coin_to_my_coin(pool: &mut Pool, faucet_coin: Coin<MY_ANOTHER_COIN>, ctx: &mut TxContext) {
