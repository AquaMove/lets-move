module 0x0::task_4 {
    ...
    fun init (ctx: &mut TxContext){
      ...
      transfer::share_object(Game{
            id: object::new(ctx),
            balance: balance::zero<FAUCETCOIN>()
        });
    ...
    entry fun deposit(game: &mut Game, coin: &mut Coin<FAUCETCOIN>, amount : u64){
